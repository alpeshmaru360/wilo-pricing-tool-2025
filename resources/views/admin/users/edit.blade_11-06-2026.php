...
<div class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
        <div class="col-sm-6">
            <h1 class="m-0 text-dark">{{ trans('global.user.title') }}</h1>
        </div><!-- /.col -->
        <div class="col-sm-6">
...
<div class="card">
    ...
    <div class="card-body">
        <form action="{{ route("admin.users.update", [$user->id]) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group {{ $errors->has('name') ? 'has-error' : '' }}">
                <label for="name">Fire-fighting Access* [0 = No Access , 1 = Access Given]</label>
                <input type="text" id="fire_fighting_access" name="fire_fighting_access" class="form-control" value="{{ old('fire_fighting_access', isset($user) ? $user->fire_fighting_access : '') }}">
                @if($errors->has('name'))
                    <em class="invalid-feedback">
                        {{ $errors->first('name') }}
                    </em>
            ...
            <div class="form-group {{ $errors->has('name') ? 'has-error' : '' }}">
                <label for="name">Atomos Access* [0 = No Access , 1 = Access Given]</label>
                <input type="text" id="atmos_access" name="atmos_access" class="form-control" value="{{ old('atmos_access', isset($user) ? $user->atmos_access : '') }}">
                @if($errors->has('name'))
                    <em class="invalid-feedback">
                        {{ $errors->first('name') }}
                    </em>
            ...
            <div class="form-group {{ $errors->has('name') ? 'has-error' : '' }}">
                <label for="name">SCP Access* [0 = No Access , 1 = Access Given]</label>
                <input type="text" id="scp_access" name="scp_access" class="form-control" value="{{ old('scp_access', isset($user) ? $user->scp_access : '') }}">
                @if($errors->has('name'))
                    <em class="invalid-feedback">
                        {{ $errors->first('name') }}
                    </em>
            ...
            <div class="form-group {{ $errors->has('name') ? 'has-error' : '' }}">
                ...
                <input type="text" id="sch_access" name="sch_access" class="form-control" value="{{ old('sch_access', isset($user) ? $user->sch_access : '') }}">
                @if($errors->has('name'))
                    <em class="invalid-feedback">
                        {{ $errors->first('name') }}
                    </em>
