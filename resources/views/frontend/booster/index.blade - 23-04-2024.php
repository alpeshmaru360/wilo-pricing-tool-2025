                        ...
                        $.ajax({
                            ...
                            success: function (response) {
                                if (response.data.booster_price){
                                    console.log(response.data.mechanical_code_price);
                                    var adder_code_price = $('#code-price').val();
                                    var enclousreItem = $('#adder-enclousre-area-item').val();
                                    console.log('valid');
    ...
    $(document).on("click", '#addtocart', function (event) {
                         ...
                         $('#Select_country_origin').on('click', function() {
							...
							$.ajax({
									...
									data: {
										...
										component: component,
                                        enclosure: enclosure,
                                        code60: code60, code61: code61,
										code65: code65, code66: code66, code67: code67,
										enclousreItem: enclousreItem,qoutation_value:qoutation_value,country:selectedCountry
                                    },
        ...
        $.ajax({
            ...
            data: {
                ...
                enclosure: enclosure,
                code60: code60, code61: code61, code65: code65, code66: code66, code67: code67,
                enclousreItem: enclousreItem,qoutation_value:qoutation_value
            },
            success: function (response) {
                if (response.url) {
