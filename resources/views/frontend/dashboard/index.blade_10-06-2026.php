    ...
    <div class="container">
        <div class="d-flex flex-center">
            ...
            <div class="componentList">
                ...
                @if(auth()->user()->scvp_access == "1")
                    <div class="componentBox" data-aos="flip-left" data-aos-offset="300"
                    data-aos-easing="ease-in-sine">
                    @if(isset($maintance_mode_scvp))
                            @if($maintance_mode_scvp == "0.0" || $maintance_mode_scvp == "0")
                            <a href="{{route('scvp.index')}}">
                                @else
                                <a href="{{route('is_maintance_mode',['label'=>'scvp_maintance_mode'])}}">
                                @endif
                            @endif
                        <label for="">
                        <img src="{{asset('fassets/images/scp_photo.JPG')}}" alt="Component image">
