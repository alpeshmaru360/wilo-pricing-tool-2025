<html>
    ...
    <body>
    <h1 style="font-size:16x;"><b>Quotation1</b></h1>
        <table class="customer-det-table">
            <tr>
                ...
                {{--<img src="{{url('https://wilo.360websitedemo.com/public/fassets/images/logo_1.png')}}" alt="Image"/>--}}
                <img src="public/fassets/images/logo_1.png" />
                {{--<img src="https://wilo.360websitedemo.com/public/fassets/images/logo_1.png" alt="Image"/>--}}
                {{--<img src="E:\Riddhi\laragon\www\wilo2\public\fassets\images\logo_1.png">--}}
                {{--<img src = "C:\inetpub\wwwroot\wilo2\wilo2\public\fassets\images\logo.png">--}}
    ...
    <table  class="inv-det-table">
        ...
        @foreach($boosterCartData as $key=> $val)
            ...
            <tr>
                ...
                <td align="left">{{App\Helpers\CurrencyHelper::withCurrency($val->price)}}
                    <span style = "">
