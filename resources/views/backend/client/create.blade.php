...
@section('title', 'Clients | Add New Client')
...
@section('content')
{{ html()->form('POST', route('admin.client.store'))->class('form-horizontal')->acceptsFiles()->open()  }}
        ...
        <div class="row">
            <div class="col-sm-5">
                <h4 class="card-title mb-0">
                    Clients
                    <small class="text-muted">Add New Client</small>
                </h4>
            </div>
            <!--col-->
