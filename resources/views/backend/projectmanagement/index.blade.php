    ...
    <div class="card-body">
        ...
        <div class="row">
            ...
            <div class="form-group col-lg-2 col-md-6">
                ...
                <button type="button" class="btn btn-danger" onclick="goBack()" title="Clear search filters">Clear</button>
            </div>
        </div>
        <!-- </form> -->
        <div class="row mt-4">
                    ...
                    <table class="table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{ $da->application_type }}</td>

                                @if (!empty($da->sub_application_type))
                                <td>{{ $da->sub_application_type }}</td>
                                @else
                                <td></td>
                                @endif
...
<script>
    function GetSelectedTextValue(value) {
        if (!isNaN(value)) {
            var url = '{{ url('admin / ajaxsubapplication ') }}' + '/' + value;
            // 
            console.log(url);
