...
<div class="card">
        ...
        <div class="row">
            <div class="col-sm-5">
                <h4 class="card-title mb-0">
                    ...
                    <small class="text-muted">@lang('labels.backend.access.roles.add')</small>
                </h4>
            </div>
            <!--col-->
        </div>
    ...
    <div class="card-footer">
        <div class="row">
            <div class="col">
                <span class="hvr_br">{{ form_cancel(route('admin.auth.role.index'), __('buttons.general.cancel')) }}</span>
            </div>
            <!--col-->
