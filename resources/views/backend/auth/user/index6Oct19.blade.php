...
<div class="card">
    <div class="card-body">
        ...
        <div class="text-right">
            <span class="hvr_br"><a href="{{ url('admin/auth/user') }}">Back</a></span>
        </div>
        @endif
        <!--col-->
    </div>
        ...
        <div class="row">
            <div class="col-md-6 col-lg-6">
                <div class="form-group new_search_div">
                    ...
                    <input type="text" class="form-control" name="search_request" id="search_request" placeholder="Search User">
            ...
            <div class="col-md-6 col-lg-2">
                <div class="form-group">
                    ...
                    <select class="form-control" id="user_status" name="user_status">
                        ...
                        <option value='{{$status}}'>{{$status == 1 ? 'Active' : 'Deactive'}}</option>
                        @endforeach
