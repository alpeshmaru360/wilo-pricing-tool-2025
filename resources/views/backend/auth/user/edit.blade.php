...
<div class="card">
    <div class="card-body">
        ...
        <div class="row mt-4 mb-4">
            <div class="col">
                ...
                <div class="row">
                    <div class="col-md-6">
                        {{ html()->label(__('First Name *'))->class('form-control-label')->for('first_name') }}
    ...
    ->required() }}
                    ...
                    <div class="col-md-6">
                        {{ html()->label(__('Last Name *'))->class('form-control-label')->for('last_name') }}
                        <div class="form-group">
                            {{ html()->text('last_name')
    ->class('form-control')
    ...
    ->required() }}
                    ...
                    <div class="col-md-6">
                        {{ html()->label(__('Email *'))->class('form-control-label')->for('email') }}
                        <div class="form-group">
                            {{ html()->email('email')
    ->class('form-control')
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            <select name="country" id="country" class="form-control">
                                ...
                                <option value="{{$c->id}}" {{ $country[0]->id == $c->id ? 'selected' : '' }}>{{$c->name}}</option>
                                @endforeach
