...
@section('title', 'Type of Sub-Application | Add New Sub-Application')
...
@section('content')
{{ html()->form('POST', route('admin.subapplication.store'))->class('form-horizontal')->acceptsFiles()->open() }}
        ...
        <div class="row">
            <div class="col-sm-5">
                <h4 class="card-title mb-0">
                    ...
                    <small class="text-muted">Add New Sub-Application</small>
                </h4>
            </div>
            <!--col-->
