...
class DashboardController extends Controller
{
    ...
    public function getDocuments(){
       // $quotations = Quotation::where('quotation_number', $quotation_no)->get();
        ...
        // dd($query_param ." ".$query_component);
        // if($query_param == "" || $query_component == ""){
        //     return redirect()->back()->with('success','Please select Article Number and Component before searching.');
        // }
        $ids = [];
        $atmosIds = [];
        $scpIds = [];
