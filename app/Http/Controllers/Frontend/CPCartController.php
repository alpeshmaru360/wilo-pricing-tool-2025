...
class CPCartController extends Controller {
    ...
    public function getControlPanelDataItemSave($request, $enclousre, $cpId, $controlPanelId) 
    {
        ...
        if (Schema::hasTable($tableName)) {
            if (Schema::hasColumn($tableName, $columnName)) {
                ...
                if ($request->adder_ids) {
                    $price = $this->addersData($request, $cpId, $controlPanelData[0]->noofpumps['id'], $controlPanelData[0]->powers['id'], $controlPanelData[0]
                        ->voltages['id']);
    ...
    public function itemSave($val = [], $brand_code, $function_code, $range, $columnName, $cpId, $totalPrice, $unitPrice, $adderCode = null, $noOfPump = null) {
        $item = new Item;
    ...
    public function updatedTotalPrice() {
		...
		$returnHTML = view('frontend.cart.qty_updated_total_price')->with('controlPanelCartData', $controlPanelCartData)
                ...
                ->with('scpvCartData', $scpvCartData)
