...
class QuotationController extends Controller {
    ...
    public function edit($quotation_no) {
        ...
        if($quotations->isNotEmpty())
        {
            ...
            $scpCartData = ScpCart::cartDataByQuotation($scpIds);
            $boosterCartData = BoosterCart::cartDataByQuotation($boosterIds);
            return view('frontend.quotation.edit', compact('quotation', 'customer', 'controlPanelCartData', 'atmosCartData', 'scpCartData', 'boosterCartData','quotations_revision_counter'));
        }
        else{
            $quotation = "";
    ...
    {
        return view('frontend.dashboard.index',compact('quotation_no'));
    }
